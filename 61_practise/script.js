...
.catch((contests)=>{
        console.log(contests+(new Error("i am an error")))
       ...
       response.then((v)=>{
        ...
        console.log(contests);
        ihtml=""
        for(xi in contests){          // we can write i or item boths or any thing its just a variable to store the index
                console.log(contests[xi])
                ...
                <div class="card mx-2 my-2" style="width: 22rem;">
                                ...
                                <div class="card-body">
                                        ...
                                        <p class="card-text"> Status is ${contests[xi].added} </p>
                                        <p class="card-text"> Version is ${contests[xi].preferred} </p>
                                </div>
                        </div>
                `
